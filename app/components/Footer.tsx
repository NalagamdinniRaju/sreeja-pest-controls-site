        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-6">
              <li className="flex gap-4 items-start">
                 ...
                 <span className="text-white/70">D No:2-3467, 1st Floor, Chennareddy colony, Piler, AP.</span>
              </li>
              <li className="flex gap-4 items-center">
                 <Phone className="text-brand-orange" size={20} />
                 <span className="text-white/70">+91 8790851377</span>
              </li>
              <li className="flex gap-4 items-center">
                 <Mail className="text-brand-orange" size={20} />
                 <span className="text-white/70">info@starpestcontrol.in</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white/5 p-8 rounded-[2rem] border border-white/10">
             <div className="flex items-center gap-4 mb-6">
                ...
                <h4 className="font-bold leading-tight">ISO 9001:2015<br/>Certified Team</h4>
             </div>
